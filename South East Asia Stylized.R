...
country_sf <- giscoR::gisco_get_countries(
  country = c("VN", "LA", "TH", "MY", "KH", "MM", "SG", "ID", "PG", "PH"),
  resolution = "1") %>%
...
raster_to_matrix(country_elevation_ref)%>%
  ...
  #                                    , data_label_column = "name")
  #             , rescale_original = TRUE)%>%
  # add_overlay(generate_label_overlay(country_sf_labels
  #                                    , attr(country_elevation_ref,"extent")
  #                                    , heightmap = raster_to_matrix(country_elevation_ref)
  #                                    , color = "#3c2f2f"
  #                                    , text_size = 3
...
# render_clouds(raster_to_matrix(country_elevation_ref)
#               , zscale = 70
#               , start_altitude = 2000
#               , end_altitude = 2800
#               , attenuation_coef = 2
...
outfile <- "images/test_plot_se_asia_stylized.png"
